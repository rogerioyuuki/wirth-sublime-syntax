...
main() {
  ...
  if [ ! -d "$SUBLIME" ]; then
    ...
    printf "git clone https://github.com/rogerioyuuki/wirth-sublime-syntax.git --branch master --single-branch --depth 1\n\n"
    exit
  fi
  ...
  env git clone https://github.com/rogerioyuuki/wirth-sublime-syntax.git "$INSTALL" --branch master --single-branch --depth 1 || {
